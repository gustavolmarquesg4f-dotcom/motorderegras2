...
test('evidência preservada ao normalizar modelo, inclusive versão',()=>{const s=normalizeCase(raw);assert.equal(s.schema,7);assert.equal(s.evidence.loan.paidInterest,200);assert.equal(s.evidence.ledgers.c.length,10)});

...
export default async function handler(req,res){
  ...
  if(!providers.length)return fail(res,503,'Nenhum modelo ativo: configure GROQ_API_KEY (Groq), Ollama HTTPS autenticado ou OPENAI_API_KEY. O Gateway automático da Vercel não garante créditos.');

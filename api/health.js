...
export default async function handler(req,res){
 ...
 res.status(200).json({name:'Plano Justo API',configured,aiConfigured,version:'8.0.0',aiProvider:process.env.OPENAI_API_KEY?'openai':aiConfigured?'vercel-ai-gateway':'not-configured'});
}
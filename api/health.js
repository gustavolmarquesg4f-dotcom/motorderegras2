...
export default async function handler(req,res){
 ...
 res.status(200).json({name:'Plano Justo API',configured,aiConfigured,version:'12.0.0',aiProvider:aiProviders[0]||'not-configured',providersConfigured:aiProviders,aiVerified:false,aiStatus:'Credenciais detectadas; teste uma análise autenticada para verificar permissão e créditos.'});
}